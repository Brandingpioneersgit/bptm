...
async def run_test():
    ...
    try:
        ...
        # Click on the Login button to start login as Super Admin
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div/div/div[2]/button[3]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Input first name and phone number for Super Admin and click Sign In button
        frame = context.pages[-1]
        ...
        # Check if there is an alternative way to log in as Super Admin or verify correct credentials
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div[2]/form/div/input').nth(0)
