...
async def run_test():
    ...
    try:
        ...
        # Click on the Login button to start login as a new employee.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div/div/div[2]/button[3]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Input first name and phone number for new employee and submit login form.
        frame = context.pages[-1]
        ...
        # Try logging in as Admin Super to access admin functions for onboarding approval.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div[2]/form/div/input').nth(0)
