...
async def run_test():
    ...
    try:
        ...
        # Click the Login button to start login as Sales user
        ...
        # Try alternative valid Sales user credentials or check for available test users to log in
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div[2]/form/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('SalesUser')
