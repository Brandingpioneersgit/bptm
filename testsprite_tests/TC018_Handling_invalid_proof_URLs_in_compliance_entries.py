...
async def run_test():
    ...
    try:
        ...
        # Check if there is a way to access proof URL entry form or payment/KPI entry form without login or try alternative credentials
        await page.mouse.wheel(0, window.innerHeight)
        

        assert False, 'Test plan execution failed: proof URL validation test case failed.'
