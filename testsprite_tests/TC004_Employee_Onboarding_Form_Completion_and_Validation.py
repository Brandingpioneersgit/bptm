...
async def run_test():
    ...
    try:
        ...
        # Click on the Login button to start login process as HR user
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div/div/div[2]/button[3]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Input username and phone number, then submit login form
        frame = context.pages[-1]
        ...
        # Check for alternative login options or retry login with corrected credentials
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div[2]/form/div/input').nth(0)
        ...
        # Request or verify correct HR user credentials for login to proceed to Employee Onboarding Form
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div[2]/form/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('HRUser')
