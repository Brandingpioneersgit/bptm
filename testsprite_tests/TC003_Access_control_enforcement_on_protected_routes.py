...
async def run_test():
    ...
    try:
        ...
        # Click the login button to attempt access to protected resources without authentication and verify redirection to login page.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div/div/div[2]/button[3]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Input 'Admin Super' as First Name and '9876543225' as Phone Number, then click Sign In to test login and role-based access control.
        frame = context.pages[-1]
