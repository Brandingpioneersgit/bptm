...
async def run_test():
    ...
    try:
        ...
        # Click the Login button to start login as Sales role
        ...
        # Check if there is an option to recover account, try alternative login, or contact support for valid Sales role credentials
        frame = context.pages[-1]
