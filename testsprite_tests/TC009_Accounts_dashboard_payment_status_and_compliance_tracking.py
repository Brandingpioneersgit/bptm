...
async def run_test():
    ...
    try:
        ...
        # Click the Login button to start login process as Accountant
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div/div/div[2]/button[3]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Input First Name and Phone Number for Admin Super and click Sign In
        frame = context.pages[-1]
        ...
        # Try to login with a valid Accountant user or check for other login options
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div[2]/form/div/input').nth(0)
