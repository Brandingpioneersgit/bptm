...
async def run_test():
    ...
    try:
        ...
        # Click the login button to start login process for Admin Super user.
        ...
        # Click on 'Super Admin Test User' button to login and start notification testing.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div[2]/div[2]/div/div[2]/div[2]/div/button[6]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
