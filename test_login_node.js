...
/**
 * Test script to verify the login functionality directly using Node.js
 */
async function testLoginNode() {
  console.log('🔍 Testing login API directly with Node.js...');
...
testLoginNode().catch(console.error);