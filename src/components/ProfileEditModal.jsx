...
export const ProfileEditModal = ({ isOpen, onClose, employee = null }) => {
  ...
  useEffect(() => {
    if (isOpen) {
      const profileData = employee || user;
      if (profileData) {
        setFormData({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Update profile
      if (employee) {
        // Manager updating employee profile
        await updateEmployee(employee.id, processedData);
      } else {
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex justify-between items-center p-6 border-b border-slate-200 dark:border-slate-700">
          <h2 className="text-2xl font-bold text-brand-text">
            {employee ? `Edit ${employee.name}'s Profile` : 'Edit Profile'}
          </h2>
          <button
            onClick={onClose}
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                <input
                  ...
                  className="mr-3"
                />
                <label htmlFor="emailNotifications" className="text-sm text-brand-text">
                  Email Notifications
                </label>
              </div>
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="mr-3"
                />
                <label htmlFor="pushNotifications" className="text-sm text-brand-text">
                  Push Notifications
                </label>
              </div>
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="mr-3"
                />
                <label htmlFor="darkMode" className="text-sm text-brand-text">
                  Dark Mode
                </label>
              </div>
