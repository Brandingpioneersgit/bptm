 ...
 * 
 * A reusable button component that provides consistent loading states,
 * visual feedback, and prevents multiple clicks during async operations.
 */
...
export const IconButton = ({ 
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      console.error('Icon button click handler failed:', error);
    } finally {
      // Reset visual state
      setTimeout(() => {
        e.target.style.transform = 'scale(1)';
